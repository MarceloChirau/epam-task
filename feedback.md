...
1.the POM should be a bit refactored: added the index.js file for components and page folders, index.js file for all page objects
...
4.only one type of assertions is used into the whole TAF
5.it's needed to add the configs for browsers
